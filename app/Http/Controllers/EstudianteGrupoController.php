...
class EstudianteGrupoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('succes', 'Estudiante grupo creado correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('estudiantes_grupos.index')->with('success','Estudiantes grupo eliminado correctamente.');
    }
}
